...
- 🎨 **四种可爱主题 + 自定义** - 玉子市场 / 海边小店 / 向日葵田 / 夜间模式 / 自定义主题
- 🎨 **主题编辑器** - 自由调整颜色、圆角、透明度、字体
- 🔍 **智能搜索** - 支持 AM 编号和关键词搜索
- 🐔 **德拉小助手** - 可爱的状态提示语
- 📦 **库存管理** - 历史记录查看与管理
- 🧹 **选择性删除** - 批量清理不需要的记录
...
v2.5.0 新增的强大功能，支持完全自定义主题样式。

### 可调整选项

- **基础模板** - 选择一个预设主题作为基础
- **颜色设置** - 主色、辅色、表面色、文字色等 6 种颜色
- **圆角大小** - 0-24px 自由调整
- **透明度** - 50%-100% 窗口透明度
- **字体选择** - 10 种字体可选
...
点击颜色输入框旁的吸管按钮，可从屏幕任意位置吸取颜色。支持原生 EyeDropper API（Chrome 95+）或备用方案。
...
- 🗑️ 移除毛玻璃功能
- 📱 手机端隐藏吸管按钮（触摸屏不适合吸管操作）
- 🐛 使用 Pointer Events + setPointerCapture 修复窗口缩放卡顿问题
- ⚡ 鼠标快速移动甩出窗口时也能继续正常缩放
...
- 🎨 **新增主题编辑器** - 完全自定义主题颜色、圆角、透明度、字体
- 🎯 **新增吸管取色** - PC端支持从屏幕任意位置吸取颜色
- 🎨 新增调色盘组件 - 色相/饱和度/明度调节
- ✨ 新增毛玻璃效果调节（已在 v2.5.2 移除）
- 📦 自定义主题自动保存

...
export const PHONE_BEAUTIFY_TEMPLATE_FORMAT = 'tamako-phone-style-pack';
...
const PHONE_BEAUTIFY_STORE_KEY = 'phoneBeautifyTemplates';
...
export function detectSpecialTemplateForTable({ sheetKey, tableName, headers = [] } = {}) {
    const safeSheetKey = normalizeString(sheetKey, 80);
...
export function detectGenericTemplateForTable({ sheetKey, tableName, headers = [] } = {}) {
    const safeSheetKey = normalizeString(sheetKey, 80);
    if (!safeSheetKey) return null;
